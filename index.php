...
<html lang="pt-br">
  ...
  <!-- <body background="images/office.jpg">!-->
    <body style="background-color:#F0FFF0">
  
    <div class="container" >
      <div class="card card-login mx-auto mt-5" style="background-color: #F5FFFA no-repeat 0 0">
        <div class="card-header"><center><b>Intranet</b></center></div>
        <div class="card-body">
          ...
          <b><i><ul>
            <li>Cadastro de avisos <i class='fas fa-check'></i></li>
            <li>Calendário <i class='fas fa-check'></i></li>
            <li>Repositório pra arquivos <i class='fas fa-check'></i></li>
          </ul></i></b>
